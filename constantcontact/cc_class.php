<?php
    ...
    */
    class WPLeads_CC_List extends WPLeads_CC_Utility {
        ...
        */    
        ...
        public function testCredentials($path = '') {
            if ( empty($path)) {
                $call = $this->apiPath.'/lists';
            } else {
                $call = $path;
    ...
    */
	class WPLeads_CC_Contact extends WPLeads_CC_Utility {		
   ...
   */
    class WPLeads_CC_Campaign extends WPLeads_CC_Utility {  
